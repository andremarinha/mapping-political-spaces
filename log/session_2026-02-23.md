...
- Implement LCA-MFA analysis in `1_analysis.qmd`
- Install required R packages (poLCA, FactoMineR, factoextra, marginaleffects, patchwork)
- Run LCA models per country, inspect BIC/entropy/item-response probabilities
- Run MFA per country with 5 active attitudinal variables, one block per ESS round
